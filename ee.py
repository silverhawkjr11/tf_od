...
train_ds = load_pascale_voc_dataset(split="train", path="ds", bounding_box_format="xywh")
valid_ds = load_pascale_voc_dataset(split="valid", path="ds", bounding_box_format="xywh")
